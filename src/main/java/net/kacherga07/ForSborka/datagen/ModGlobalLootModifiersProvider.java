...
import net.kacherga07.ForSborka.loot.AddItemModifier;
import net.kacherga07.ForSborka.loot.AddSusSandItemModifier;
...
public class ModGlobalLootModifiersProvider extends GlobalLootModifierProvider {
    ...
    protected void start() {
        ...
        add("strawberry_from_creeper", new AddItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(new ResourceLocation("entities/creeper")).build()}, ModItems.STRAWBERRY.get()));

        add("metal_detector_from_jungle_temples", new AddItemModifier(new LootItemCondition[] {
                new LootTableIdCondition.Builder(new ResourceLocation("chests/jungle_temples")).build()}, ModItems.METAL_DETECTOR.get()));
